...
export default function GirisPage() {
  ...
  async function emailGiris(e: React.FormEvent) {
    e.preventDefault();
    setHata("");
    setYukleniyor(true);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-md">
        ...
        <button
          onClick={googleGiris}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors mb-4"
        >
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Hesabınız yok mu?{" "}
          <Link href="/kayit" className="text-yellow-600 font-medium hover:underline">
            Kayıt Ol
          </Link>
        </p>
      </div>
